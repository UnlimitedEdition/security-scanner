...
> **Trenutna verzija: `2026-04-13-v4`**
>
...
Primer: `2026-04-13-v4` = cetvrta verzija (prva od 13. aprila 2026).
...
### 1. Backend (api.py)
- `consent_version` string u POST /scan endpoint (~linija gde je `consent_version: "2026-04-13-v4"`)
- `consent_version` string u wizard execute endpoint

### 2. Frontend (index.html)
- `consent_version` u JavaScript `startScan()` funkciji
- Consent checkbox tekst — `(verzija 2026-04-13-v4)` link

### 3. Politika privatnosti (privacy.html)
- Subtitle SR: `Verzija <strong>2026-04-13-v4</strong>`
- Subtitle EN: `Version <strong>2026-04-13-v4</strong>`
- Sekcija 10 SR: `Trenutna verzija politike: 2026-04-13-v4`
- Sekcija 10 EN: `Current policy version: 2026-04-13-v4`
...
- Subtitle SR + EN: `Version 2026-04-13-v4`

### 4b. Politika refundacije (refund-policy.html)
- Subtitle SR + EN: `Verzija/Version 2026-04-13-v4`
...
- `verBadge.textContent = 'v4'` — kratka oznaka u navbar-u
- `verBadge.title = '2026-04-13-v4'` — puna verzija na hover

### 6. Ovaj fajl (VERSION.md)
- Gornji red: `Trenutna verzija: 2026-04-13-v4`

## Procedura za promenu verzije

1. Odluci novu verziju (npr. `2026-05-15-v5`)
...
| Verzija | Datum | Opis |
|---|---|---|
| `2026-04-13-v4` | 13. apr 2026 | Javna galerija rezultata (opt-in objava, sekcija 15 u privacy) |
